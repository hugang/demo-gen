package io.hugang.demo.generator.common.aspect;

import io.hugang.demo.generator.common.page.PageResult;
import io.hugang.demo.generator.common.utils.EncryptUtils;
...
public class EncryptParameterAspect {
     ...
     * @throws Throwable 异常
     */
    @Around("execution(* io.hugang.demo.generator.controller.DataSourceController.*(..))")
    ...
    private void handleItem(Object item, boolean isDecrypt) {
        ...
        // 只处理在entity包下面的对象
        if (Objects.isNull(item.getClass().getPackage()) || !item.getClass().getPackage().getName().startsWith("io.hugang.demo.generator.entity")) {
            return;
        }
