INSERT INTO sys_menu (pid, name, url, authority, type, open_style, icon, sort, version, deleted, creator, create_time, updater, update_time) VALUES (33, '代码生成器', '{{apiUrl}}/demo-generator/index.html', '', 0, 0, 'icon-rocket', 2, 0, 0, 10000, now(), 10000, now());
...
INSERT INTO gen_base_class (package_name, code, fields, remark, create_time) VALUES ('io.hugang.demo.framework.mybatis.entity', 'BaseEntity', 'id,creator,create_time,updater,update_time,version,deleted', '使用该基类，则需要表里有这些字段', now());

INSERT INTO gen_project_modify (project_name, project_code, project_package, project_path, modify_project_name, modify_project_code, modify_project_package, exclusions, modify_suffix, create_time) VALUES ('demo-boot', 'demo', 'io.hugang.demo', 'c:/demo/demo-boot', 'demo-boot', 'demo', 'io.hugang.demo', '.git,.idea,target,logs', 'java,xml,yml,txt', now());
INSERT INTO gen_project_modify (project_name, project_code, project_package, project_path, modify_project_name, modify_project_code, modify_project_package, exclusions, modify_suffix, create_time) VALUES ('demo-cloud', 'demo', 'io.hugang.demo', 'c:/demo/demo-cloud', 'demo-cloud', 'demo', 'io.hugang.demo', '.git,.idea,target,logs', 'java,xml,yml,txt', now());
